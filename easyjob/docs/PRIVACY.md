# EasyJob — Privacy policy (extension & companion services)

**Last updated:** 2026-05-14

EasyJob is an open-source job application tracker. It includes a **Chrome extension** (side panel) and optional **self-hosted** web app and API. This document describes what data can be processed and how you control it.

## Who is responsible

If you install the extension and connect it to **your own** EasyJob API, **you** (or the organization running that API) are the data controller for data stored on that server.
...
Depending on how you use EasyJob, the self-hosted API may process:
...
EasyJob does not use the extension to inject third-party advertising or cross-site tracking cookies. Any cookies would come only from **your** API or web app host, under that deployment’s policy.
...
EasyJob is not directed at children under 13, and we do not knowingly collect personal information from children.
...
For the open-source project, open an issue on the **EasyJob** GitHub repository you obtained this code from.

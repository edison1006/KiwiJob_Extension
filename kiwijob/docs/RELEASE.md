...
- **API**: FastAPI + SQLModel; liveness/readiness checks; email plus optional Google/Apple authentication; account-scoped jobs, resumes, match analysis, CV optimization, copilot, and analytics; PostgreSQL/Alembic; durable rate limits; explicit CORS and production configuration validation.
